...
public class CorteDeCaja extends MetodosDiseño {
	...
	protected JFrame  CrearGui() {
		...
		adjustComponents(gbc_lbDineroApertura,0,1,1,1,1.0,0.0,GridBagConstraints.CENTER);
		...
		adjustComponents(gbc_jtDineroApertura,0,2,1,1,0.0,0.0,GridBagConstraints.NORTH);
		...
		adjustComponents(gbc_lbDineroCierre,0,3,1,1,0.0,0.0,GridBagConstraints.NORTH);
		...
		adjustComponents(gbc_jtDineroCierre,0,4,1,1,0.0,0.0,GridBagConstraints.NORTH);
		...
		adjustComponents(gbc_lbSumaTotal,0,5,1,1,0.0,0.0,GridBagConstraints.NORTH);
		...
		adjustComponents(gbc_jtSumaTotal,0,6,1,1,1.0,0.0,GridBagConstraints.NORTH);
		...
		adjustComponents(gbc_lbHoraApertura,0,7,1,1,1.0,0.0,GridBagConstraints.SOUTHWEST);
		...
		adjustComponents(gbc_jtHoraApertura,0,8,1,1,1.0,0.0,GridBagConstraints.NORTHWEST);
