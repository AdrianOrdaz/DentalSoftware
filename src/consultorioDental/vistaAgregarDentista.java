...
public class vistaAgregarDentista extends metDiseño implements ActionListener{
	...
	private static void crearfAD()
	{
		vistaAgregarDentista fAD = new vistaAgregarDentista();
		...
		JLabel lbAgregarDentista = new JLabel("Agregar Dentista");
		lbAgregarDentista.setFont (lbAgregarDentista.getFont ().deriveFont (41.0f));
		adjustLabel(lbAgregarDentista, c, con, 1, 0, 3, 1, 1.0, 1.0, GridBagConstraints.EAST);
